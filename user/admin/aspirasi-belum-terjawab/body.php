...
<div class="row">  
    <div class="col-md-3 col-sm-3">
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="#">Aspirasi Belum Terjawab</a></li>
 	...
 	<div class="col-md-9 col-sm-9">	
		...
		<div class="row">
			...
			<?php
				...
				$sql  		= "SELECT * FROM tb_aspirasi where kd_unit=".$_SESSION['kd_unit']." and status='belum terjawab'";                        
				$result  	= mysqli_query($db, $sql);
				$total		= mysqli_num_rows($result);
				if(mysqli_num_rows($result) > 0){
					$no = 1;
					echo' <h5><b>Anda memiliki '. $total.' aspirasi yang belum anda jawab.</b></h5>';
					...
					while($row = mysqli_fetch_assoc($result)){
						...
						echo'<tr>
							...
							<td>	'. $row['subjek'].'			</td>
							<td>	'. $row1['nama'].'		</td>
							<td style="text-align:center;"><a href=cekkode/index.php?kd_aspirasi='.$row['kd_aspirasi'].'>Jawab</a></td>
							</tr>';
