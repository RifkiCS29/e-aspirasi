 	...
 	<div class="col-md-9 col-sm-9">	
		...
		<div class="row">
			...
			<?php
				...
				$sql  		= "SELECT * FROM tb_aspirasi where nim=".$_SESSION['nim']." and status='belum terjawab'";                        
				$result  	= mysqli_query($db, $sql);
				$total		= mysqli_num_rows($result);
				if(mysqli_num_rows($result) > 0){
					$no = 1;
					echo' <h5><b>Anda memiliki '. $total.' aspirasi yang belum terjawab oleh admin unit kerja.</b></h5>';
					...
					echo'<h5><b>Anda tidak memiliki aspirasi yang belum terjawab.</b></h5>';
				?>                   
                </table>
            </div>				
			</div>			
